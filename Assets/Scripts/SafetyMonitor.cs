...
public class SafetyMonitor : MonoBehaviour
{
		...
		void pointDownRange()
		{
				...
				AbstractGun rGun = null;
				AbstractGun lGun = null;
		...
		void checkPointingDownRange(AbstractGun gun)
		{
				...
				if ( !downRange && pistol.loadedMagazine != null && ScreenText.firedOnce ) {//Might want to use collider filters so that you dont get bugs when shooting	
